  ...
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.supports">
      <div class="discounts-left">
        <div class="activity">
          <span class="content-tag">
            <span class="mini-tag">{{infoSupportsName}}</span>
          </span>
          <span class="activity-content ellipsis">{{infoSupportsContent}}</span>
        </div>
      </div>
        ...
        <div class="activity-sheet" v-show="false">
            <div class="activity-sheet-content">
                ...
                <ul class="list">
                    <!-- 活动列表 -->
                        <!-- 颜色控制 -->
                    <li class="activity-item" v-for="(item,index) in info.supports" :key="index" :class="supportClasses[index]">
                        <span class="content-tag">
...
export default {
  ...
  //    computed: {
  //        infoSupportsName(){
  //          return this.infoSupportsName = this.info.supports[0].name;

  //        },
  //        infoSupportsContent(){
  //         return this.infoSupportsContent = this.info.supports[0].content;
  ...
  //   //   console.log(this.infoSupportsContent);
